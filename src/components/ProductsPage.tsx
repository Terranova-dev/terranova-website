...
const products = [
  {
    ...
    title: "Microconcrete",
    text: "Made with raw materials sourced from Europe, Microconcrete is site-finished in the tone and sheen you choose. Every surface is levelled to perfection and applied with a seamless finish, in any colour or texture of your choice.",
  ...
  },
  {
    ...
    title: "Hard",
    text: "A waterproof and breathable plaster for durable, seamless surfaces with a refined mineral finish. Hard can be site-finished in the colour and texture chosen for your space.",
